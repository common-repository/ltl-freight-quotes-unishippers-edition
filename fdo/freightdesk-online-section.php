...
<div class="user_guide_fdo">
        ...
        if (!$fdo_coupon_data['fdo_user']) {
            ...
            <div id="message" class="en-coupon-code-div woocommerce-message en-coupon-notice">
                ...
                <p>
                    ...
                    <a href="javascript:void(0)" onclick="en_unishippers_ltl_fdo_connection_status_refresh(this);">this
                        link</a>
            ...
            <div id="message" class="en-coupon-code-div woocommerce-message en-coupon-notice">
                ...
                <div class='en-coupon-btn-div'>
                    <button class="en_fdo_unishippers_ltl_apply_promo_btn button"
    ...
    if (get_option('en_fdo_company_id_status') != 1) {
        $button_connect = '<a href="javascript:void(0)" id="fd_online_id_unishippers" class="button-primary">Connect</a>';
        ...
        if (get_option('en_fdo_company_id_status') == 1) {
            $button_connect = '<a href="javascript:void(0)" data="disconnect" id="fd_online_id_unishippers" class="button-primary">Disconnect</a>';
